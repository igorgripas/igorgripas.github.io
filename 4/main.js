...
const Tweet = React.createClass({
  ...
  generateClassName(classNameStr, classNamesProperties) {
    console.log('generateClassName', classNameStr, classNamesProperties);
  ...
  calculateTextSize: function (likes, retweets) {
    let textFontSize = 12;
    if (Number(likes + retweets)) {
      textFontSize += 2 * Math.log(likes + retweets)
    }
    return textFontSize;
  },
  ...
  render() {
    ...
    const textFontSize = this.calculateTextSize(likes, retweets);
    return (
        <div className="tweet">
          ...
          <div className="tweet-body">
            ...
            <p className="tweet-text" style={{fontSize: textFontSize}}>
              {text}
            </p>
            ...
            <div className="tweet-stats">
              <div className={this.generateClassName('tweet-retweets', {'retweeted': isRetweeted})}>
                <i className="tweet-stat-icon fa fa-retweet"/>
                {retweets || null}
              </div>
              <div className={this.generateClassName('tweet-likes', {'liked': isLiked})}>
